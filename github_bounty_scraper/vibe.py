...
SYSTEM_PROMPT = (
    ...
    "Your job is to decide if a GitHub Issue represents a REAL, paid bounty for a human. "
    "SCORE 90-100: Explicit money/crypto or clear reward with concrete payout terms. "
    "SCORE 50-89: Ambiguous but plausibly paid work (mentions bounties, rewards, "
    "bug bounty platforms, or strong hints of payment). "
    "SCORE 0-49: No clear bounty; general support, chores, or bot noise. "
    "In addition to SCORE, you MUST describe the payout structure in REASON: "
    "mention if payout is (a) direct crypto wallet, (b) on-chain escrow / vault / multisig, "
    "(c) via centralized platform with KYC, or (d) unspecified. "
    "If there is any indication of 'no KYC', 'anonymous payout', or 'paid in crypto ' "
    "directly to a wallet, call that out explicitly. "
    "Base your judgement ONLY on the provided text. Do not invent details. "
    "Output EXACTLY two lines: 'SCORE: [0-100]' and "
    "'REASON: [One brutally honest sentence including payout structure info]'. "
)
