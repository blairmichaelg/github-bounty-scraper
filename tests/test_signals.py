...
class TestLaneBlocking:
    ...
    def test_assignment_stale_by_comment(self):
        ...
        timeline = [{"__typename": "AssignedEvent", "createdAt": "2024-01-01T00:00:00Z"}]
    ...
    def test_assignment_not_stale_old_comment(self):
        ...
        timeline = [{"__typename": "AssignedEvent", "createdAt": "2024-01-02T00:00:00Z"}]
    ...
    def test_lane_blocked_edge_cases(self):
        ...
        signals = {"active_label_signals_re": re.compile("active"), "blocked_authors": ["bot"]}
        # Malformed labels
        ...
        comments = [
            {
                "author": {"login": "bot"},
                "body": "I am working on it (long body to pass len check)",
                "createdAt": "2024-01-01T00:00:00Z",
            }
        ]
...
def test_apply_hard_disqualifiers_edge_cases():
    ...
    disq, _ = apply_hard_disqualifiers(issue_state="OPEN", labels_nodes=[], body=None, comments=[], signals=signals)
    assert disq is False
    # Hit in body
    ...
    disq, _ = apply_hard_disqualifiers(issue_state="OPEN", labels_nodes=[], body="hello", comments=[], signals={})
    assert disq is False
